...
extern const uint32_t g_flash_BlockAddresses[86]; // array of flash block addresses indexed by block #
...
void rdk_meta_defaults(void)
{
  ...
  //const unsigned char meta_server_ip[6] = {96,126,102,194,0,80};
