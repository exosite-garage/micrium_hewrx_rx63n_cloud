...
#define  NET_TMR_CFG_NBR_TMR                              30u   /* Configure total number of TIMERs (see Note #1).      */
...
#define  NET_TCP_CFG_RX_WIN_SIZE_OCTET            (2 * 1460u)   /* Configure TCP connection receive  window size.       */
#define  NET_TCP_CFG_TX_WIN_SIZE_OCTET            (2 * 1460u)   /* Configure TCP connection transmit window size.       */


                                                                /* Configure TCP connections' default maximum ...       */
                                                                /* ... segment lifetime timeout (MSL) value,  ...       */
#define  NET_TCP_CFG_TIMEOUT_CONN_MAX_SEG_SEC              1u   /* ... in integer seconds (see Note #3).                */
...
#define  NET_SOCK_CFG_NBR_SOCK                             2    /* Configure total number of sockets.                   */
...
#define  NET_SOCK_CFG_TIMEOUT_CONN_CLOSE_MS              500u
...
#define  NET_SECURE_CFG_SERVER_DOWNGRADE_EN     DEF_DISABLED
                                                                /*   DEF_DISABLED   Server downgrade DISABLED           */
                                                                /*   DEF_ENABLED    Server downgrade ENABLED            */


#define  NET_SECURE_CFG_MAX_NBR_SOCK                       5    /* Configure maximum number of sockets to secure.       */

                                                                /* Configure maximum number of certificate authorities  */
#define  NET_SECURE_CFG_MAX_NBR_CA                         1    /* ... that can be installed.                           */


                                                                /* Configure maximum length (in octets) of ...          */
#define  NET_SECURE_CFG_MAX_KEY_LEN                     1500    /* ... certificate authority, certificates & keys.      */

                                                                /* Configure maximum length (in octets) of common name  */
#define  NET_SECURE_CFG_MAX_ISSUER_CN_LEN                 20    /* ... (see Note #5).                                   */

                                                                /* Configure maximum length (in octets) of public key   */
#define  NET_SECURE_CFG_MAX_PUBLIC_KEY_LEN               256    /* ... (see Note #6).                                   */
