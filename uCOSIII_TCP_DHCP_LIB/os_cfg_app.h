...
#define  OS_CFG_ISR_STK_SIZE             384u               /* Stack size of ISR stack (number of CPU_STK elements)   */
...
#define  OS_CFG_INT_Q_TASK_STK_SIZE      384u               /* Stack size (number of CPU_STK elements)                */
...
#define  OS_CFG_TICK_TASK_STK_SIZE       384u               /* Stack size (number of CPU_STK elements)                */
