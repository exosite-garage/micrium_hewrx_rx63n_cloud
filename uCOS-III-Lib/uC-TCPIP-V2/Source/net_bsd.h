...
*                               that "32767" is the "Minimum Acceptable Value ... [for] {SSIZE_MAX}".
*
...
*                                             MODULE END
*
* Note(s) : (1) The BSD 4.x Layer module include MUST end PRIOR to the validation of all BSD 4.x 
*               Layer configuration (see 'net_bsd.h  CONFIGURATION ERRORS' & 'net_cfg.h  BSD 4.x 
*               LAYER CONFIGURATION').
*
*               See also 'net_bsd.h  MODULE'.
*********************************************************************************************************
*/
