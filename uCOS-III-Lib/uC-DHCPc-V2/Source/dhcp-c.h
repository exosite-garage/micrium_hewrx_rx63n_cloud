...
#define  DHCPc_VERSION                                 20802u   /* See Note #1.                                         */
...
*
*               (c) '\<DHCPc>\' directories                                             See Note #1c
*
...
#define  DHCPc_ERR_NONE_NO_TMR                              1
#define  DHCPc_ERR_NONE_LOCAL_LINK                          2

#define  DHCPc_ERR_INIT_INCOMPLETE                         10   /* DHCPc init NOT completed.                            */
#define  DHCPc_ERR_INIT_SOCK                               11   /* Sock  init err.                                      */

#define  DHCPc_ERR_NULL_PTR                                15   /* Ptr arg(s) passed NULL ptr(s).                       */
#define  DHCPc_ERR_INVALID_MSG_SIZE                        16   /* Invalid DHCP msg size.                               */
#define  DHCPc_ERR_INVALID_HW_ADDR                         17   /* Invalid/NO hw addr.                                  */
#define  DHCPc_ERR_INVALID_MSG                             18   /* Invalid DHCP msg.                                    */
#define  DHCPc_ERR_OPT_BUF_SIZE                            19   /* Opt val buf size too small.                          */
#define  DHCPc_ERR_PARAM_REQ_TBL_SIZE                      20   /* Req param tbl size too small.                        */

#define  DHCPc_ERR_IF_CFG_STATE                            20   /* IP cfg state err.                                    */
#define  DHCPc_ERR_IF_CFG                                  21   /* IF cfg err.                                          */
#define  DHCPc_ERR_IF_NOT_CFG                              22   /* IF NOT yet cfg'd with DHCP.                          */
#define  DHCPc_ERR_IF_INVALID                              23   /* IF invalid or disabled.                              */
#define  DHCPc_ERR_IF_NOT_MANAGED                          24   /* IF NOT managed by DHCP client.                       */
#define  DHCPc_ERR_IF_OPT_NONE                             25   /* DHCP opt NOT present on IF.                          */

#define  DHCPc_ERR_IF_INFO_NONE_AVAIL                      30   /* IF info  pool empty.                                 */
#define  DHCPc_ERR_IF_INFO_IF_USED                         31   /* IF info  already already used for this IF.           */

#define  DHCPc_ERR_MSG_NONE_AVAIL                          40   /* Msg      pool empty.                                 */
#define  DHCPc_ERR_MSG_Q                                   41   /* Err posting to msg Q.                                */

#define  DHCPc_ERR_COMM_NONE_AVAIL                         50   /* Comm obj pool empty.                                 */

#define  DHCPc_ERR_TMR_NONE_AVAIL                          60   /* Tmr      pool empty.                                 */
#define  DHCPc_ERR_TMR_INVALID_MSG                         61   /* Invalid tmr msg.                                     */
#define  DHCPc_ERR_TMR_CFG                                 62   /* Err cfg'ing tmr.                                     */

#define  DHCPc_ERR_ADDR_VALIDATE                           70   /* Err validating addr.                                 */
#define  DHCPc_ERR_ADDR_USED                               71   /* Addr in use.                                         */

#define  DHCPc_ERR_LOCAL_LINK                              75   /* Err cfg'ing dyn link-local addr.                     */

#define  DHCPc_ERR_RX                                      80   /* Rx err.                                              */
#define  DHCPc_ERR_RX_OVF                                  81   /* Rx err data buffer ovf.                              */
#define  DHCPc_ERR_RX_NAK                                  82   /* NAK msg rx'd.                                        */
#define  DHCPc_ERR_RX_MSG_TYPE                             83   /* Rep msg type err.                                    */

#define  DHCPc_ERR_TX                                      90   /* Tx err.                                              */


/*
*********************************************************************************************************
*                                 DHCPc-OS LAYER ERROR CODES DEFINES
*********************************************************************************************************
*/

#define  DHCPc_OS_ERR_NONE                               1000

#define  DHCPc_OS_ERR_INIT                               1010
#define  DHCPc_OS_ERR_CFG                                1011

#define  DHCPc_OS_ERR_INIT_SIGNAL                        1020
#define  DHCPc_OS_ERR_INIT_SIGNAL_NAME                   1021
#define  DHCPc_OS_ERR_INIT_SIGNALD                       1022
#define  DHCPc_OS_ERR_INIT_LOCK                          1023
#define  DHCPc_OS_ERR_INIT_LOCK_NAME                     1024
#define  DHCPc_OS_ERR_INIT_Q                             1025
#define  DHCPc_OS_ERR_INIT_Q_NAME                        1026
#define  DHCPc_OS_ERR_INIT_TMR                           1027
#define  DHCPc_OS_ERR_INIT_TMR_SIGNAL                    1028
#define  DHCPc_OS_ERR_INIT_TMR_SIGNAL_NAME               1029

#define  DHCPc_OS_ERR_INIT_TASK                          1040
#define  DHCPc_OS_ERR_INIT_TASK_NAME                     1041
#define  DHCPc_OS_ERR_INIT_TMR_TASK                      1042
#define  DHCPc_OS_ERR_INIT_TMR_TASK_NAME                 1043

#define  DHCPc_OS_ERR_LOCK                               1050
#define  DHCPc_OS_ERR_MSG_Q                              1051
#define  DHCPc_OS_ERR_TMR                                1052
...
struct dhcpc_if_info {
    ...
    NET_IP_ADDR         ServerID;                               /* Server responsible for lease (in net order).         */
...
#error  "DHCPc_CFG_IP_PORT_SERVER                not #define'd in 'app_cfg.h'"
...
#error  "DHCPc_CFG_IP_PORT_CLIENT                not #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  >= NET_PORT_NBR_MIN]    "
#error  "                                  [     &&  <= NET_PORT_NBR_MAX]    "
...
#error  "DHCPc_CFG_MAX_RX_TIMEOUT_MS             not #define'd in 'app_cfg.h' "
...
#error  "DHCPc_CFG_MAX_RX_TIMEOUT_MS       illegally #define'd in 'app_cfg.h' "
#error  "                                  [MUST be  >= NET_OS_TIMEOUT_MIN_mS]"
#error  "                                  [     &&  <= NET_OS_TIMEOUT_MAX_mS]"
#endif
...
#error  "DHCPc_CFG_BROADCAST_BIT_EN              not #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "

#elif  ((DHCPc_CFG_BROADCAST_BIT_EN != DEF_DISABLED) && \
        (DHCPc_CFG_BROADCAST_BIT_EN != DEF_ENABLED ))
#error  "DHCPc_CFG_BROADCAST_BIT_EN        illegally #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "
#endif
...
#error  "DHCPc_CFG_PARAM_REQ_TBL_SIZE            not #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  >= 1  ]                 "
#error  "                                  [     &&  <= 255]                 "
...
#error  "DHCPc_CFG_PARAM_REQ_TBL_SIZE      illegally #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  >= 1  ]                 "
#error  "                                  [     &&  <= 255]                 "
#endif
...
#error  "DHCPc_CFG_MAX_NBR_IF                    not #define'd in 'app_cfg.h' "
#error  "                                  [MUST be  >= 1                    ]"
...
#error  "DHCPc_CFG_MAX_NBR_IF              illegally #define'd in 'app_cfg.h' "
#error  "                                  [MUST be  >= 1                    ]"
#error  "                                  [     &&  <= NET_IF_CFG_MAX_NBR_IF]"
#endif
...
#error  "DHCPc_CFG_ADDR_VALIDATE_EN              not #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "

#elif  ((DHCPc_CFG_ADDR_VALIDATE_EN != DEF_ENABLED ) && \
        (DHCPc_CFG_ADDR_VALIDATE_EN != DEF_DISABLED))
#error  "DHCPc_CFG_ADDR_VALIDATE_EN        illegally #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "
#endif
...
#error  "DHCPc_CFG_DYN_LOCAL_LINK_ADDR_EN        not #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "

#elif  ((DHCPc_CFG_DYN_LOCAL_LINK_ADDR_EN != DEF_DISABLED) && \
        (DHCPc_CFG_DYN_LOCAL_LINK_ADDR_EN != DEF_ENABLED ))
#error  "DHCPc_CFG_DYN_LOCAL_LINK_ADDR_EN  illegally #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "
#endif
...
#error  "DHCPc_CFG_LOCAL_LINK_MAX_RETRY          not #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  >=   1]                 "
#error  "                                  [     &&  <= 255]                 "
                     ...
                     1,                              \
                     DEF_INT_08U_MAX_VAL) != DEF_OK)
#error  "DHCPc_CFG_LOCAL_LINK_MAX_RETRY    illegally #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  >=   1]                 "
#error  "                                  [     &&  <= 255]                 "
#endif
...
#error  "DHCPc_CFG_ARG_CHK_EXT_EN                not #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "

#elif  ((DHCPc_CFG_ARG_CHK_EXT_EN != DEF_DISABLED) && \
        (DHCPc_CFG_ARG_CHK_EXT_EN != DEF_ENABLED ))
#error  "DHCPc_CFG_ARG_CHK_EXT_EN          illegally #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "
#endif
...
#error  "DHCPc_CFG_ARG_CHK_DBG_EN                not #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "

#elif  ((DHCPc_CFG_ARG_CHK_DBG_EN != DEF_DISABLED) && \
        (DHCPc_CFG_ARG_CHK_DBG_EN != DEF_ENABLED ))
#error  "DHCPc_CFG_ARG_CHK_DBG_EN          illegally #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "
#endif
...
#error  "DHCPc_DBG_CFG_MEM_CLR_EN                not #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "

#elif  ((DHCPc_DBG_CFG_MEM_CLR_EN != DEF_DISABLED) && \
        (DHCPc_DBG_CFG_MEM_CLR_EN != DEF_ENABLED ))
#error  "DHCPc_DBG_CFG_MEM_CLR_EN          illegally #define'd in 'app_cfg.h'"
#error  "                                  [MUST be  DEF_DISABLED]           "
#error  "                                  [     ||  DEF_ENABLED ]           "
#endif
...
#if     (NET_VERSION < 206u)
#error  "CPU_CORE_VERSION  [SHOULD be >= V2.06]"
#endif
